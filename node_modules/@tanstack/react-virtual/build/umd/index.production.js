...
/**
   ...
   *
   * @license MIT
   */function i(e,t,s){let n,i=[];return()=>{let o;s.key&&null!=s.debug&&s.debug()&&(o=Date.now());const l=e();if(!(l.length!==i.length||l.some(((e,t)=>i[t]!==e))))return n;let r;if(i=l,s.key&&null!=s.debug&&s.debug()&&(r=Date.now()),n=t(...l),null==s||null==s.onChange||s.onChange(n),s.key&&null!=s.debug&&s.debug()){const e=Math.round(100*(Date.now()-o))/100,t=Math.round(100*(Date.now()-r))/100,n=t/16,i=(e,t)=>{for(e=String(e);e.length<t;)e=" "+e;return e};console.info(`%c⏱ ${i(t,5)} /${i(e,5)} ms`,`\n            font-size: .6rem;\n            font-weight: bold;\n            color: hsl(${Math.max(0,Math.min(120-120*n,120))}deg 100% 31%);`,null==s?void 0:s.key)}return n}}
/**
   * virtual-core
   *
   * Copyright (c) TanStack
