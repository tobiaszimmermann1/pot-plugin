...
/**
 * include class CPTBestellrunden
 */
...
function fc_init_gateway_class() {
    ...
    class WC_Foodcoop_Guthaben extends WC_Payment_Gateway {
 		...
 		public function __construct() {
        	...
        	$this->method_title = 'Foodcoop Guthaben';
        	$this->method_description = 'Pre-Pay Guthaben für die Foodcoop'; // will be displayed on the options page
        	$this->supports = array(
        		'products',
                'refunds'
        	);
        ...
        /**
 		...
 		public function init_form_fields(){
        	...
        	$this->form_fields = array(
        		'enabled' => array(
        			'title'       => 'Aktivieren',
        			'label'       => 'Foodcoop Guthaben aktivieren',
        			'type'        => 'checkbox',
        			'description' => '',
        			'default'     => 'yes'
        		),
        		'title' => array(
        			'title'       => 'Title',
        			'type'        => 'text',
        			'description' => 'Titel, den Mitglieder beim Checkout sehen.',
        			'default'     => 'Foodcoop Guthaben',
        			'desc_tip'    => true,
        		),
        		'description' => array(
        			'title'       => 'Description',
        			'type'        => 'textarea',
        			'description' => 'Beschreibung, die Mitglieder beim Checkout sehen.',
        			'default'     => 'Bezahle mit deinem Foodcoop Guthaben.',
        		)
        	);
        ...
        public function payment_fields() {
            ...
            $bestellrunde = new \Inc\Base\CPTBestellrunden();
