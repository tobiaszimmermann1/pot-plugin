...
class FoodcoopProductImport {
  ...
  function enqueue_admin_js(){
    wp_enqueue_script( 'product-import-upload', FOODCOOP_PLUGIN_URL. 'scripts/product-import/product-import-upload.js?version=1.8.0', array( 'jquery-ui-core', 'jquery-ui-tabs' ), null, false );  
