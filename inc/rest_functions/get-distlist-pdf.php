<?php
  ...
  foreach( $lieferanten as $lieferant ){
    ...
    <div style="margin-top:0cm;font-size:7pt;font-family:Arial; width: 100%;">
      ...
      <tr>
        <td style="padding:5px 10px 5px 10px;border-bottom:1px solid black;font-weight:bold;vertical-align:top;" colspan="2">'.__("Verteilliste","fcplugin").'</td>
      </tr>
        <tr>
    ...
    foreach( $users_by_lieferant[$lieferant] as $user) {
      $body .= '
      <td style="padding:5px 5px 5px 5px; border-bottom:1px solid #8e8e8e; border-right: 1px solid #8e8e8e; font-weight:bold;font-size:7pt;text-rotate:90;width:0.5cm;text-align:left; vertical-align:bottom;">'.$user.'</td>
      ';
    }

    $body .= '
    <td style="padding:3px 10px 3px 10px; border-bottom:1px solid #8e8e8e; border-right: 1px solid #8e8e8e; font-size:7pt;width:0.5cm;">AK</td>
    <td style="padding:3px 10px 3px 10px; border-bottom:1px solid #8e8e8e; font-size:7pt;width:5cm;">Notiz</td>
    </tr>
    ';
    ...
    foreach($products_by_lieferant[$lieferant] as $product) {
      $body .= '
        <tr>
          ...
          $body .= '
            <td style="padding:3px 10px 3px 10px; border-bottom:1px solid #8e8e8e; border-right: 1px solid #8e8e8e; font-size:7pt;"></td>
            <td style="padding:3px 10px 3px 10px; border-bottom:1px solid #8e8e8e; border-right: 1px solid #8e8e8e; font-size:7pt;"></td>
          </tr>
          ';        
    }
